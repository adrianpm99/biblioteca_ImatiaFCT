...
REPLACE INTO lending VALUES   
    ...
    (1,2,1619647200000,1620943200000, 1618358400000, 'Entregado en buen estado'),  

    (2,3,1619647200000,1620943200000, 1608681600000, 'Entregado en mal estado(mojado)'),  

    (3,1,1617235200000,1618444800000, NULL, NULL ),  

    (4,6,1607558400000,1608854400000, NULL, NULL ),  
...
REPLACE INTO copyshelving VALUES  
