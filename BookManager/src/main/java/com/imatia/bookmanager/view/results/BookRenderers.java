...
/**
 * These utils receive a list of books
...
{	
	 ...
	 * @param bookList searched by title (complete or single words)
	 */
	...
	/**
	 * shows: id, title, ISBN
	 * @param bookList searched by author (complete name or single words)
	 */
	 ...
	 * @param bookList searched by ISBN (just one result)
	 */
